...
const METAL = {
  ...
  gold: ["#f7e2b8", "#e3c07c", "#a9823f", "#f7eccf"],
  bronze: ["#e6b98a", "#c98a56", "#85572e", "#ecc9a8"]
};
...
for (let k = 0; k < 20; k++) {
  ...
  P2_BASE.push(makeWatch(1, k, {
    metal, bracelet, complication: comp,
    colorKey: ["ivory", "wine", "navy", "wine", "silver", "blue"][k % 6],
    glow: "#3a2f1c"
  }));
}
const comps2 = { k: 0 };
...
for (let k = 0; k < 20; k++) {
  ...
  P3_BASE.push(makeWatch(2, k, {
    ...
    colorKey: ["navy", "black", "burgundy", "slate", "blue"][k % 5],
    glow: "#3a2f4c"
  }));
}
